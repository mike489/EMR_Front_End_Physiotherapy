...
const ActivePatients = () => {
  ...
  const handleFetchingPatients = async () => {
    ...
    const Api = `${Backend.auth}${Backend.patientsActive}?${params.toString()}`;
    const header = {
  ...
  return (
    <PageContainer title="Active Patients">
      <Grid container>
          ...
          <Grid container>
            <Grid item xs={12}>
              {loading ? (
                ...
                <ErrorPrompt
                  title="Server Error"
                  message="Unable to retrieve active patients."
                />
              ) : data.length === 0 ? (
                <Fallbacks
                  severity="evaluation"
                  title="Active Patients Not Found"
                  description="The list of active patients will be listed here."
                  sx={{ paddingTop: 6 }}
                />
              ) : (
                <TableContainer
