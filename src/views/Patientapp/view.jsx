...
const ViewAppointment = () => {
  ...
  return (
    <PageContainer back={true} title={`Appointment Details - ${appointment.patient_name || 'Unknown Patient'}`}>
...
>
  {!appointment.patient_picture_url && appointment.patient_name?.charAt(0)}
</Avatar>
              {/* </Paper> */}
            </Grid>
            <Grid item xs={12} md={9}>
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6} md={4}>
                  ...
                  <Typography variant="body1">{appointment.patient_name || '-'}</Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Box display="flex" alignItems="center" gap={2} mb={0.5}>
                ...
                <Grid item xs={12} sm={6} md={4}>
                  ...
                  <Typography variant="body1">{appointment.gender || '-'}</Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Box display="flex" alignItems="center" gap={2} mb={0.5}>
                    <Typography variant="subtitle2" color="textSecondary">Age</Typography>
                  </Box>
                  <Typography variant="body1">{appointment.age ? `${appointment.age} years` : '-'}</Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Box display="flex" alignItems="center" gap={2} mb={0.5}>
