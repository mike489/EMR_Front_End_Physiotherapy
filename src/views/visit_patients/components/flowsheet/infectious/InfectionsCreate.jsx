...
const InfectionsCreate = ({ visit, onClose }) => {
  ...
  const handleCreate = async () => {
    ...
    const Api = `${Backend.auth}${Backend.infectious}`;
    const headers = {
    ...
    try {
      ...
      if (data.success) {
        toast.success('Infections assessment created successfully!');
        setFormData({ precaution: [] });
...
export default InfectionsCreate;