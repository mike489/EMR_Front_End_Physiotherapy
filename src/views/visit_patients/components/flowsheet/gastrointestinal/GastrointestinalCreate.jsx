...
const GastrointestinalCreate = ({ visit, onClose }) => {
  ...
  const handleCreate = async () => {
    ...
    const Api = `${Backend.auth}${Backend.gastrointestinalAssessments}`;
    const headers = {
    ...
    try {
      ...
      if (data.success) {
        toast.success('Gastrointestinal assessment created successfully!');
        setFormData({
          assessment_date: '',
          last_bowel_movement: '',
          consistency: '',
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" sx={{ mb: 3, fontWeight: 'bold' }}>
        Create Gastrointestinal Assessment
      </Typography>
...
export default GastrointestinalCreate;