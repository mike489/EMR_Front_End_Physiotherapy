...
const RespiratoryCreate = ({ visit, onClose }) => {
    ...
    const handleCreate = async () => {
        ...
        const Api = `${Backend.auth}${Backend.respiratoryAssessments}`;
        const headers = {
        ...
        try {
            ...
            if (data.success) {
                toast.success('Respiratory assessment created successfully!');
                setFormData({
                    respiratory_type: '',
                    respiratory_pattern: '',
                    chest_pattern: '',
...
export default RespiratoryCreate;