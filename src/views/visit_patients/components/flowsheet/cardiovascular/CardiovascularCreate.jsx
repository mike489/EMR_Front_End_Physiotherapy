...
const CardiovascularCreate = ({ visit, onClose }) => {
  ...
  const handleCreate = async () => {
    ...
    const Api = `${Backend.auth}${Backend.cardiovascularAssessments}`;
    const headers = {
    ...
    try {
      ...
      if (data.success) {
        toast.success('Cardiovascular assessment created successfully!');
        setFormData({
          assessment_date: '',
          's1/s2_sound': '',
          murmur: '',
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" sx={{ mb: 3, fontWeight: 'bold' }}>
        Create Cardiovascular Assessment
      </Typography>
...
export default CardiovascularCreate;