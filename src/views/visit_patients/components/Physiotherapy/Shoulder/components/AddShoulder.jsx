...
const AddShoulder = ({ open, isSubmitting, onClose, onSubmit, visit }) => {
  ...
  const strengthTests = [
    ...
    { key: 'protraction', label: 'Protraction' },
  ];
  ...
  const palpationTests = [
    ...
    { key: 'infra_spinouts', label: 'Infra Spinouts' },
    { key: 'mid_traps', label: 'Mid Traps' },
    { key: 'erector_spinae', label: 'Erector Spinae' },
    { key: 'rhomboids', label: 'Rhomboids' },
    { key: 'intercostal_muscles', label: 'Intercostal Muscles' },
