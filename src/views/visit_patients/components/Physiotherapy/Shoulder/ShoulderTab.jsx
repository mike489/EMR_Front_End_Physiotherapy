...
import AddShoulder from './components/AddShoulder';

const ShoulderTab = ({ visit }) => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      {loading ? (
        ...
        <ErrorPrompt
          title="Server Error"
          message="Unable to retrieve Shoulder."
        />
      ) : complaints.length === 0 ? (
        <Fallbacks
          severity="info"
          title="No Shoulder data Found"
          description="Shoulder data will be listed here when available."
          sx={{ paddingTop: 6 }}
        />
      ) : (
