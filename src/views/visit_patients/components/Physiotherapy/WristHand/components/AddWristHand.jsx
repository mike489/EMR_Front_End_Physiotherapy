...
const AddWristHand = ({ open, isSubmitting, onClose, onSubmit, visit }) => {
  const [formData, setFormData] = useState({
    ...
    range_of_motion: {
      ...
      finger_flexion: { left: '', right: '' },
      finger_extension: { left: '', right: '' },
    },
    rom_remark: '',

    // Strength for wrist and hands
    ...
    strength_grip_right: '',
    strength_grip_left: '',
    strength_pinch_right: '',
    strength_pinch_left: '',
    strength_finger_abduction_right: '',
    strength_finger_abduction_left: '',
    strength_finger_adduction_right: '',
    strength_finger_adduction_left: '',
    strength_remark: '',

    // Special tests for wrist and hands
    special_tests: [],
  ...
  const specialTests = [
    {
      name: "Phalen's Test",
      description: 'Carpal tunnel syndrome - wrist flexion for 60 seconds',
    },
    {
      name: "Tinel's Sign",
      description: 'Carpal tunnel syndrome - tapping over median nerve',
    },
    {
    ...
    },
    {
      ...
      description: 'Carpal tunnel syndrome - direct pressure on carpal tunnel',
    },
    {
      name: 'Grind Test',
      description: 'Thumb CMC joint arthritis',
    },
  ];
  ...
  const strengthTests = [
    ...
    { key: 'pinch', label: 'Pinch Strength' },
    { key: 'finger_abduction', label: 'Finger Abduction' },
    { key: 'finger_adduction', label: 'Finger Adduction' },
  ];

  const palpationTests = [
    { key: 'carpal_tunnel', label: 'Carpal Tunnel' },
    { key: 'thenar_eminence', label: 'Thenar Eminence' },
    { key: 'hypothenar_eminence', label: 'Hypothenar Eminence' },
    { key: 'wrist_joint_line', label: 'Wrist Joint Line' },
    { key: 'finger_joints', label: 'Finger Joints' },
    { key: 'thumb_base', label: 'Thumb Base (CMC)' },
  ];

  const biomechanicalTests = [
    { key: 'wrist_mechanics', label: 'Wrist Mechanics' },
    { key: 'finger_mechanics', label: 'Finger Mechanics' },
    { key: 'grip_pattern', label: 'Grip Pattern' },
    { key: 'pinch_pattern', label: 'Pinch Pattern' },
  ];

  const romTests = [
    { key: 'wrist_flexion', label: 'Wrist Flexion', normal: '60-80°' },
    { key: 'wrist_extension', label: 'Wrist Extension', normal: '60-70°' },
    { key: 'radial_deviation', label: 'Radial Deviation', normal: '20°' },
    { key: 'ulnar_deviation', label: 'Ulnar Deviation', normal: '30-40°' },
    { key: 'supination', label: 'Supination', normal: '80-90°' },
    { key: 'pronation', label: 'Pronation', normal: '80-90°' },
    { key: 'finger_flexion', label: 'Finger Flexion', normal: 'Full' },
    { key: 'finger_extension', label: 'Finger Extension', normal: 'Full' },
  ];
  ...
  const handlePalpationChange = (testKey, value) => {
    handleArrayToggle('palpations', { [testKey]: value });
  };
    ...
    >
      <DialogTitle>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Typography variant="h6">Wrist & Hands Assessment</Typography>
                    ...
                    <TableRow key={test.key}>
                      ...
                      <TableCell>
                        <FormControl size="small" fullWidth>
                          <Select
                            value={
                              formData.palpations.find((p) => p[test.key])?.[
                                test.key
                              ] || ''
                            }
                            onChange={(e) =>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              placeholder="Improve grip strength, Reduce pain during functional activities..."
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
