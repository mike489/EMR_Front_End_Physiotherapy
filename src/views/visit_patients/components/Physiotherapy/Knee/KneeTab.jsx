...
import AddKnee from './components/AddKnee';
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      {loading ? (
        ...
        <ErrorPrompt title="Server Error" message="Unable to retrieve Knee." />
      ) : complaints.length === 0 ? (
        <Fallbacks
          severity="info"
          title="No Knee data Found"
          description="Knee data will be listed here when available."
          sx={{ paddingTop: 6 }}
        />
      ) : (
