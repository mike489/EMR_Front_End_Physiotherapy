...
import AddHip from './components/AddHip';
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      {loading ? (
        ...
        <ErrorPrompt title="Server Error" message="Unable to retrieve Hip." />
      ) : complaints.length === 0 ? (
        <Fallbacks
          severity="info"
          title="No Hip data Found"
          description="Hip data will be listed here when available."
          sx={{ paddingTop: 6 }}
        />
      ) : (
